...
func TestFuncname(t *testing.T) {
	tests := []struct {
		...
		{"", ""},
		{"runtime.main", "main"},
		{"github.com/fengjx/go-halo/errs.funcname", "funcname"},
		{"funcname", "funcname"},
...
func TestStackTraceFormat(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		"\n" +
			"github.com/fengjx/go-halo/errs.stackTrace\n" +
			"\t.+/github.com/fengjx/go-halo/errs/stack_test.go:174\n" +
			"github.com/fengjx/go-halo/errs.TestStackTraceFormat\n" +
			"\t.+/github.com/fengjx/go-halo/errs/stack_test.go:225",
	}, {
		stackTrace()[:2],
		"%#v",
